...
const Filters = ({onFilter, onSearch, onFilterActivities, onOrder, onOrderByPopulation}) => {
      ...
      <nav className={style.filterContainer}>
        <ul className={style.filterList}>
          <li className={style.searchContainer}>
            ...
            />
            <button onClick={handleSearch} className={style.searchButton}><img src="https://icones.pro/wp-content/uploads/2021/06/icone-loupe-noir.png"></img></button>
          </li>
          <li>
          ...
          <li>
            <select id="orderPopulation" onChange={handleOrderByPopulation} disabled={false}>
                <option value="none" hidden> Order by population</option>
          ...
          <li>
            <select id="filterActivity" onChange={handleFilterActivities}>
              <option value="none" hidden>Filter by activity</option>
